...
SERVER_TRUSTSTORE="$SERVER_PATH/server.truststore.pk12"
...
trust $SERVER_TRUSTSTORE $CLIENT_CA $CLIENT_CA_ALIAS
trust $SERVER_TRUSTSTORE $SERVER_CA $SERVER_CA_ALIAS
